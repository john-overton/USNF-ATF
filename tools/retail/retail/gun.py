...
def export(pt_path: Path, output: Path, tracer_color: str | None = None) -> dict:
    ...
    result = {
        ...
        'ballisticsNote': 'Authored: M61 6000 rpm, GD 1030 m/s; paired Mk12 1000 rpm each, NAVPERS 10826-B approximately 3300 ft/s. Gravity only; drag, dispersion, recoil and damage not modeled. One visible tracer per five actual rounds; belt color is an authored default, not decoded retail color.',
